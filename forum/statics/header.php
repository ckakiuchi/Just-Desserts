				...
				<div class="login_box">
					...
					<?php
						...
						if (isLoggedIn()) {
							...
							$sqlLog="SELECT * FROM members WHERE member_id='$userIdLogged'";
							$resultLog=mysqli_query($GLOBALS["___mysqli_ston"], $sqlLog);
							$value = mysqli_fetch_array($resultLog);
							echo "<h3>Hello ". $value['firstname'] ." ". $value['lastname'] ."!</h3><br><a href='../index.php'>Go to home  </a>   |   <a href='logout.php'>  Logout</a>";
						} else {
						// end 1a
					 ?>
