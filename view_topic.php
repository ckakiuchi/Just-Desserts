<?php
	...
	// =========================================
	// retrieves username from database server
...
<!-- ========================================= -->
<!-- shows username of who posted the topic in the forum-->
<tr>
...
<td width="77%" bgcolor="#F8F7F1">aaa<?php echo $rows['firstname']; ?></td>
</tr>
<tr>
...
<?php
			...
			// if user is logged in, user can respond to forum posts.
			// if user is not logged in, user can't respond to forum posts.
			if (isLoggedIn()){
